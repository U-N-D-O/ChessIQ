...
namespace
{
  ...
  public:
    ...
    ~AudioplayersWindowsPlugin() override;
  ...
  private:
    ...
    static inline EventStreamHandler<> *globalEvents = nullptr;
      ...
      PluginRegistrarWindows *registrar)
  {
    ...
    globalEvents = new EventStreamHandler<>();
    auto _obj_stm_handle =
        static_cast<StreamHandler<EncodableValue> *>(globalEvents);
