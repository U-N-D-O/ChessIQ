...
class RemoteFriendInviteLinkService {
  ...
  /// Extracts a valid invite code from either a raw code or a QR payload.
  ///
  /// QR codes generated by ChessIQ contain a hosted invite URL, but accepting
  /// the raw six-character code as well makes scanning simpler for external
  /// QR generators and keeps the scanner independent from URL navigation.
  String? inviteCodeFromScannedValue(String? scannedValue) {
    final directCode = normalizeInviteCode(scannedValue);
    if (directCode != null) {
      return directCode;
    }
