...
This document describes the Academy leaderboard data flow currently used by ChessIQ.
...
When the app registers or updates an Academy leaderboard profile, ChessIQ may send the following data to its backend services:
...
## Data We Do Not Ask You To Enter
